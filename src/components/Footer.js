	...
	return (
		<div className='footer'>
			<a href={Resume} target='_blank' rel='noopener noreferrer'>
				<FontAwesomeIcon icon={['fas', 'file']} size='lg' className='icon' />
			</a>
			<a
			...
			<a
				...
				target='_blank'
				rel='noopener noreferrer'>
				<FontAwesomeIcon icon={['fab', 'github']} size='lg' className='icon' />
			</a>
			<a
				href='https://twitter.com/JonathanHoDev'
				target='_blank'
				rel='noopener noreferrer'>
				<FontAwesomeIcon icon={['fab', 'twitter']} size='lg' className='icon' />
			</a>
